...
const CreditScoreCalculator: React.FC = () => {
  ...
  This credit score estimator provides an approximate score based on user input and simplified calculations. It does not use proprietary algorithms from CIBIL, Equifax, TransUnion CIBIL, or CRIF High Mark, nor does it access your actual credit report. For an accurate credit score, check with credit bureaus like CIBIL, Equifax, TransUnion CIBIL, or CRIF High Mark, or use services like CreditMantri or Paisabazaar.
</p>
          </div>
        </section>
